...
public class Pokedex implements Initializable
{
    ...
    @FXML
    private ListView <String> listPokemon; //Lista donde guardaré el nombre de todos los pokemon
    ...
    @FXML
    private Button btnSeleccionarPokemon; //Boton que usaré para volver al menu
    
    @FXML
    private Button btnAyuda; //Boton que usaré para abrir la ayuda del usuario.
    ...
    public void volverMenu()
    {
         try
        {
            ...
            System.out.println(Singleton.getInstancia().getPokemonPersonalizado());
    ...
    public void seleccionarPokemon()
    {
        String nombrePokemon="";
         try
        {
            nombrePokemon= listPokemon.getSelectionModel().getSelectedItem();
           
            //Singleton.getInstancia().añadirPokemonPersonalizado(nombrePokemon, 0);
           Singleton.getInstancia().setPokemonPersonalizado(nombrePokemon);
    ...
    public void abrirAyuda() //Metodo que abre la ventana ayuda y me cierra la actual
    {
        ...
        {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("ayudaPokedex.fxml"));
