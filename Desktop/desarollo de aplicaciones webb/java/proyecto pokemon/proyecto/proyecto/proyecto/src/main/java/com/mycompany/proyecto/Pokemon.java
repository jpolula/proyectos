...
public class Pokemon 
{
   ...
   // private int type; //numero que irá desde el 1 hasta el 17.
    ...
    private double  bonificacionPrimerAtacante(int tipoDefensor)//defensor es el tipo que recibe el ataque y atacante es el que hace el ataque.
    ...
    public int dañoNormalPokemon(Pokemon defensor) //Funcion que me calcula el daño normal normal que hace un pokemon
    {
      ...
      double  daño1=(1*bonificacion*1*v);
      double daño2=((0.2*nivel+1)*ataque);
      double daño3=25*defensor.getDefensa();
              
              
       double dañoTotal=daño1*(daño2/daño3)+2;
    ...
    public int dañoEspecialPokemon(Pokemon defensor) //Funcion que me calcula el daño especial que hace el pokemon
    {
      ...
      double  daño1=(1*bonificacion*1*v);
      double daño2=((0.2*nivel+1)*ataqueEspecial);
      double daño3=25*defensor.getDefensaEspecial();
      double dañoTotal=daño1*(daño2/daño3)+2;
      ataqueEspecialRealizado=true;
      return (int)dañoTotal;
    }
    
    public void restarVidaOponente(Pokemon defensor)//Funcion que le resta la vida del oponente al recibir un ataque normal.
    {
       defensor.setVidaActual(defensor.getVidaActual()-dañoNormalPokemon(defensor));
    }
    
    public void restarVidaEspecialOponente(Pokemon defensor) //Funcion que le resta la vida del oponente al recibir un ataque especial
    {
       defensor.setVidaActual(defensor.getVidaActual()-dañoEspecialPokemon(defensor));
    }
