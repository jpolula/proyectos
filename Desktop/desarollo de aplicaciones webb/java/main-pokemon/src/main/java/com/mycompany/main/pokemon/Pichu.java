 ...
 * @author Juan Pedro
 */
public class Pichu implements Pokemonn
{
    ...
    public Pichu(String entrenador,int salu) //Constructor de la clase. el usuario solo pondrá el nombre del entrenador ya que la salud no cambiará y la exp se ganara combatiendo.
    {
        this.entrenador=entrenador;
       salud=salu;
    }
    
     public Pichu(String entrenador,int salu,int exp) //Constructor de la clase. el usuario solo pondrá el nombre del entrenador ya que la salud no cambiará y la exp se ganara combatiendo.
    {
        this.entrenador=entrenador;
       salud=salu;
       experiencia=exp;
    ...
    {
        Pichu otroPokemon=(Pichu)otro;
        if(experiencia==otroPokemon.getExp())
        {
            return true;
        }
        else
