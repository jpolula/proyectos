...
// Llave de cierre eliminada por corregir_sintaxis.php
}
...
try {
    ...
    $horario = $horario_especifico . ' (' . $horario_turno . ')';
                ...
                header("Location: index.php");
                exit;
            if (!$hay_disponibilidad) { // Reemplazado else por if (!$hay_disponibilidad)
...
} // Cierre añadido para el if de la línea 286