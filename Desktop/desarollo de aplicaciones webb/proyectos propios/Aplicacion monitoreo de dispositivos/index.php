...
// Inicializar/restaurar la configuración si es necesario
initialize_config();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_ip'])) {
    ...
    $device_type = isset($_POST['device_type']) ? $_POST['device_type'] : 'router';
    add_ip_to_config($new_ip, $new_service, $device_type);
...
if (!isset($_GET['action'])) {
    foreach ($ips_to_monitor as $ip => $details) {
