...
<body class="bg-gradient-to-br from-[#E0FAF4] via-[#72E8D4] to-[#51B2E0] min-h-screen w-full flex flex-col items-center justify-center overflow-x-hidden px-2 sm:px-0 text-2xl">
    <div class="w-full flex flex-row items-start max-w-6xl">
        <a href="admin.php" class="w-auto flex flex-row  gap-2 bg-[#72B0E8] hover:bg-[#72E8AC] text-[#21476B] hover:text-white transition-all duration-200 px-8 py-4 rounded-2xl shadow-xl font-bold text-xl text-center border-2 border-[#72E8AC] group">
    ...
    <div class="w-full max-w-6xl bg-[#E0FAF4]/95 border-4 border-[#72E8AC] rounded-[2.5rem] shadow-[0_8px_40px_0_rgba(81,178,224,0.18)] p-2 flex flex-col">
        <h1 class="text-4xl font-bold text-[#256353] mb-12 w-full text-center">Gestión de Empleados</h1>
        <?php 
        ...
        <table class="w-full text-left rounded-3xl overflow-hidden text-2xl shadow-xl border-separate border-spacing-0 mt-12">
            <thead>
                <tr class="bg-gradient-to-r from-[#72E8AC]/90 to-[#51E080]/80 text-[#256353]">
                    ...
                    <th class="py-7 px-10 font-bold uppercase tracking-widest border-b-4 border-[#51E080]">Correo</th>
                    <th class="py-7 px-10 font-bold uppercase tracking-widest border-b-4 border-[#51E080]">Rol</th>
            ...
            <tbody>
                ...
                <tr class="border-b last:border-b-0 hover:bg-[#72E8AC]/40 transition duration-200 group">
                    ...
                    <td class="py-7 px-10 flex flex-row gap-4 items-center justify-center text-3xl bg-[#E0FAF4]/80">
                        <a href="editarEmpleado.php?id=<?= $emp['IdEmpleado'] ?>" title="Editar" class="flex flex-col items-center justify-center gap-2 bg-[#72E8AC] hover:bg-[#72E884] text-[#256353] hover:text-white transition-all duration-200 px-4 py-3 rounded-2xl font-bold text-xl text-center border-2 border-[#72E884] group">
                          <span class="material-symbols-outlined scale-125 group-hover:text-white transition-all duration-200">edit</span>
                        </a>
                        <a href="eliminarEmpleado.php?id=<?= $emp['IdEmpleado'] ?>" title="Borrar" class="flex flex-col items-center justify-center gap-2 bg-[#72B0E8] hover:bg-[#72E8AC] text-[#21476B] hover:text-white transition-all duration-200 px-4 py-3 rounded-2xl font-bold text-xl text-center border-2 border-[#72E8AC] group">
        ...
        <div class="w-full flex justify-center mt-12">
            <a href="anadirEmpleado.php" class="w-auto flex flex-row items-center justify-center gap-2 bg-[#72E8AC] hover:bg-[#72E884] text-[#256353] hover:text-white transition-all duration-200 px-8 py-4 rounded-2xl font-bold text-xl text-center border-2 border-[#72E884] group">
                <span class="material-symbols-outlined scale-125 group-hover:text-white transition-all duration-200">add_circle</span>
                <span class="text-center group-hover:text-white transition-all duration-200">Añadir empleado</span>
            </a>
        </div>
    </div>
    <?php 
